...
[<img src="https://github-ads.s3.eu-central-1.amazonaws.com/posthog-experiments.jpg?t=1" width="419px" />](https://spatie.be/github-ad-click/posthog-experiments)
...
```bash
php artisan vendor:publish --tag="posthog-experiments-migrations"
php artisan migrate
```
...
```bash
php artisan vendor:publish --tag="posthog-experiments-views"
```

## Usage

```php
$posthogExperiments = new CarAndClassic\PosthogExperiments();
echo $posthogExperiments->echoPhrase('Hello, CarAndClassic!');
```
...
- [Wesley Martin](https://github.com/wesleymartincc)
